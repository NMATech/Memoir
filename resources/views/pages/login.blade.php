...
<body>
    <div class="w-[100%] flex bg-red-500 h-screen">
            ...
            <div class="form w-[80%] m-auto p-5">
                ...
                <form>
                    <div class="grid gap-6">
                        <div class="mt-6">
                            <label for="username" class="block mb-2 text-xl font-medium font-bold">Username</label>
                        ...
                        <div class="flex flex-col justify-center items-center">
                            ...
                            <p class="font-bold">Don't have an account? <a href=""
